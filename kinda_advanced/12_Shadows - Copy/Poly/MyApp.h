...
protected:
	...
	std::vector<PolyCommand> m_commandLog;
	...
	void ExecuteAndLog(const std::string& cmd, const std::vector<float>& args);
	bool SavePolyFromLog(const std::string& filename) const;
